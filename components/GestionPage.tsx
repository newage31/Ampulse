...
export default function GestionPage({ selectedHotel }: GestionPageProps) {
  ...
  const quickActions = [
    {
      ...
      action: () => setActiveTab('gestion-clients')
    },
    {
      id: 'nouvelle-facture',
      ...
      action: () => setActiveTab('gestion-factures')
    },
    {
      id: 'relances',
      label: 'Relances',
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {quickActions.map((action) => (
              <button
                ...
                className={`${action.color} text-white p-4 rounded-lg flex flex-col items-center space-y-2 transition-all duration-200 transform hover:scale-105`}
              >
                {action.icon}
  ...
  return (
    <div>
      ...
      {!selectedHotel && (
        <div className="px-6 py-6 bg-gradient-to-r from-yellow-50 to-orange-50 border-b border-yellow-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-yellow-700 text-sm">
                  Veuillez sélectionner un établissement pour accéder à la gestion
                </p>
              </div>
            </div>
