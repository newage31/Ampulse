...
export default function RoomDashboard({ selectedHotel, onActionClick }: RoomDashboardProps) {
  ...
  const quickActions = [
    ...
    { 
      label: "Modifier chambre", 
      action: "edit-room", 
      icon: Edit,
      description: "Modifier une chambre existante",
    ...
    { 
      ...
      icon: Eye,
      description: "Consulter la disponibilité",
    ...
    { 
      ...
      action: "cleaning", 
      icon: Shield,
      description: "Planifier le nettoyage",
      color: "bg-indigo-50 hover:bg-indigo-100 border-indigo-200"
    },
    { 
      label: "Rapport chambres", 
      action: "room-report", 
      icon: BarChart3,
