        ...
        <Card className="border-blue-200 bg-blue-50">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-2">
                <h4 className="font-semibold text-blue-800">Actions rapides</h4>
                <div className="space-y-2">
                  <Button 
                    variant="outline" 
                    size="sm" 
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          ...
          <CardContent>
            <p className="text-yellow-800">
              Veuillez sélectionner un établissement dans les paramètres pour voir les données spécifiques à cet établissement.
            </p>
          </CardContent>
        </Card>
      )}
