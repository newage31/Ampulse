...
export default function HotelDetail({ hotel, onBack, onEditHotel }: HotelDetailProps) {
  const [rooms, setRooms] = useState<Room[]>([
    { id: 1, numero: "101", type: "Simple", prix: 45, statut: "disponible", description: "Chambre simple avec salle de bain" },
    { id: 2, numero: "102", type: "Double", prix: 65, statut: "occupee", description: "Chambre double avec salle de bain" },
    { id: 3, numero: "103", type: "Familiale", prix: 85, statut: "disponible", description: "Chambre familiale avec 2 lits" },
    { id: 4, numero: "201", type: "Simple", prix: 45, statut: "maintenance", description: "Chambre simple avec salle de bain" },
  ]);
