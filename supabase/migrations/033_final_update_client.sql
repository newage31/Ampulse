-- Migration 033: Fonction update_client finale

-- Supprimer toutes les anciennes versions de update_client
DROP FUNCTION IF EXISTS update_client(INTEGER, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, TEXT, TEXT, VARCHAR, VARCHAR, VARCHAR, TEXT, TEXT[], VARCHAR, NUMERIC, UUID, VARCHAR, VARCHAR, NUMERIC, INTEGER, VARCHAR, DATE, VARCHAR, INTEGER, DATE, VARCHAR, VARCHAR, VARCHAR, INTEGER, VARCHAR, VARCHAR, UUID);
DROP FUNCTION IF EXISTS update_client(INTEGER, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, TEXT, VARCHAR, VARCHAR, VARCHAR, VARCHAR, TEXT, VARCHAR, VARCHAR, VARCHAR, INTEGER, VARCHAR, INTEGER, INTEGER, UUID);

-- Créer la fonction update_client finale
