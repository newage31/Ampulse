-- Migration 026: Correction de la fonction search_clients

-- Supprimer l'ancienne fonction search_clients
DROP FUNCTION IF EXISTS search_clients(TEXT, INTEGER, VARCHAR, INTEGER);
DROP FUNCTION IF EXISTS search_clients(TEXT, INTEGER, VARCHAR, INTEGER, INTEGER);

-- Recréer la fonction search_clients
