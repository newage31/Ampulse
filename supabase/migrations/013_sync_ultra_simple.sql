-- Migration ultra-simplifiée pour synchroniser la structure et les données
-- Date: 2025-01-27
...
-- Processus réservations (structure simplifiée)
INSERT INTO processus_reservations (nom, description, etapes, actif)
SELECT 'Processus Standard', 'Processus de réservation standard', 
       '[{"nom": "Vérification", "ordre": 1}, {"nom": "Confirmation", "ordre": 2}]'::jsonb, 
       true
