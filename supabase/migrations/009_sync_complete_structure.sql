-- Migration complète pour synchroniser la structure et les données
-- Date: 2025-01-27
...
-- Colonnes manquantes pour hotels
...
-- Insertion des hotels manquants
INSERT INTO hotels (nom, adresse, ville, code_postal, pays, telephone, email, description, etoiles, actif)
VALUES 
    ('Hotel Bella Vista', '123 Avenue de la Paix', 'Nice', '06000', 'France', '+33493123456', 'contact@bellavista.fr', 'Hôtel de charme avec vue sur mer', 4, true),
    ('Grand Hotel Imperial', '45 Boulevard Haussmann', 'Paris', '75009', 'France', '+33142345678', 'reservation@grandimperial.fr', 'Hôtel de luxe au cœur de Paris', 5, true)
