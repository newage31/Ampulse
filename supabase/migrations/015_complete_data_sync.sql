-- Migration pour synchroniser complètement les données avec seed.sql
-- Ajouter les colonnes manquantes aux hôtels
...
-- Supprimer les hôtels de test et insérer les vrais hôtels du seed.sql
DELETE FROM hotels WHERE nom IN ('Hotel Bella Vista', 'Grand Hotel Imperial');
...
UPDATE hotels SET 
  ...
  statut = 'ACTIF',
  chambres_total = 52,
  chambres_occupees = 41,
  taux_occupation = 78.85,
...
-- Insérer les 2 hôtels manquants
INSERT INTO hotels (nom, adresse, ville, code_postal, telephone, email, gestionnaire, statut, chambres_total, chambres_occupees, taux_occupation, siret, tva_intracommunautaire, directeur, telephone_directeur, email_directeur, capacite, categories, services, horaires) VALUES
...
('Résidence Temporaire Victor Hugo', '89 avenue Parmentier', 'Paris 11e', '75011', '01.42.00.05.05', 'contact@residencetemporairevictorhugo.fr', 'Anne Petit', 'ACTIF', 35, 26, 74.29, '56789012345678', 'FR56789012345', 'Anne Petit', '01.42.00.05.05', 'directeur@residence-victor-hugo.fr', 35, ARRAY['Hébergement d''urgence', 'Insertion sociale'], ARRAY['Accompagnement social', 'Restaurant'], '{"checkIn": "15h30", "checkOut": "11h00", "reception": "24h/24"}'::jsonb);
...
-- Créer les chambres manquantes avec la nouvelle structure
...
ALTER TABLE usagers ADD COLUMN IF NOT EXISTS usager_id INTEGER;
...
INSERT INTO clients (nom, prenom, email, telephone, adresse, ville, code_postal, date_naissance, type_client, notes) VALUES
('Bernard', 'Pierre', NULL, '06.45.67.89.01', '67 rue Saint-Antoine, 75004 Paris', 'Paris', '75004', '1978-11-08', 'particulier', 'Prix standard'),
('Thomas', 'Sophie', 'sophie.thomas@email.com', '06.23.45.67.89', '89 avenue Parmentier, 75011 Paris', 'Paris', '75011', '1989-05-30', 'particulier', 'Jeune en insertion');
...
-- Mettre à jour les opérateurs sociaux avec plus d'informations
...
-- Ajouter 2 opérateurs sociaux manquants
INSERT INTO operateurs_sociaux (nom, prenom, organisation, telephone, email, statut, specialite, zone_intervention, nombre_reservations, notes, siret, adresse, responsable, telephone_responsable, email_responsable, agrement, date_agrement, zone_intervention_array, specialites, partenariats) VALUES
...
-- Ajouter la convention de prix manquante
INSERT INTO conventions_prix (operateur_id, hotel_id, prix_nuit, date_debut, date_fin, statut) VALUES
(5, 2, 40.00, '2024-01-01', '2024-12-31', 'active');
...
(1, 1, 1, 1, 'Jean Dubois', '2024-01-15', '2024-02-15', 1, 'EN_COURS', 1395.00, 'SIAO 75', 31, 'Accompagnement social en cours', 1, 1, 0),
(2, 2, 1, 1, 'Marie Martin', '2024-01-20', '2024-03-20', 3, 'EN_COURS', 2700.00, 'SIAO 75', 60, 'Famille avec 2 enfants', 2, 1, 2),
(3, 4, 1, 3, 'Pierre Bernard', '2024-01-10', '2024-01-25', 2, 'TERMINEE', 675.00, 'Emmaüs', 15, 'Séjour terminé avec succès', 3, 1, 1),
(4, 7, 1, 4, 'Sophie Thomas', '2024-02-01', '2024-02-28', 1, 'EN_COURS', 1820.00, 'Secours Catholique', 28, 'Chambre double', 4, 1, 0);
...
-- Mise à jour des triggers updated_at pour toutes les tables modifiées
UPDATE hotels SET updated_at = NOW() WHERE id IN (1, 2, 3, 4, 5);
